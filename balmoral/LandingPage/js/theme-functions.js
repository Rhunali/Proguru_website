    ...
    INSPIRO.loader = function () {
        ...
        if (!$body.hasClass('no-page-loader')) {
            ...
            $wrapper.animsition({
                ...
                loadingInner: '<img src="' + pageLoaderStylePath + pageLoaderStyle + '">', // e.g '<img src="loading.gif" />'
                timeout: false,
        ...
        if ($sliderCarousel.exists()) {
            $sliderCarousel.each(function () {
                var element = $(this),
                    ...
                    $sliderCarouseDots = element.attr('data-carousel-dots') || true,
                    $sliderCarouseNav = false,
                    $sliderCarouseAutoPlay = element.attr('data-carousel-autoplay') || true,
                    $carouselAutoplayTimeout = element.attr('data-autoplay-timeout') || 8000,
